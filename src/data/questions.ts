...
export const questions: Question[] = [
  ...
  },
  {
    ...
    explanation:
      "Стрессоустойчивость – это способность действовать эффективно в условиях неопределённости. В ситуации, с которой столкнулась компания Airbnb, важно не просто «делать что-то» быстро, а анализировать данные и принимать продуманные решения. Благодаря последовательности компания смогла адаптировать продукт и коммуникацию: внедрила гибкие условия отмен, сосредоточилась на локальных и краткосрочных поездках и оперативно информировала пользователей.",
  },
  {
    id: "q4",
    title: "Вопрос 4/5",
  ...
  },
  {
    ...
    explanation:
      "Стратегическое мышление – это способность видеть за пределами сегодняшней выгоды и принимать решения, которые укрепят позиции компании в будущем. В случае с IKEA ставка на устойчивые материалы и программы переработки требовала крупных инвестиций и не давала мгновенной отдачи. Но именно этот выбор превратил бренд в символ доступной, но при этом ответственной мебели и помог отразить критику.",
  },
];
